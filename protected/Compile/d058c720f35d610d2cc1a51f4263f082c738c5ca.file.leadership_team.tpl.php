<?php /* Smarty version Smarty-3.1.19, created on 2020-04-17 12:27:32
         compiled from "/var/www/html/aptitudecare/dev/protected/Views/public/leadership_team.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2647209905e7027aea8fb23-82574504%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd058c720f35d610d2cc1a51f4263f082c738c5ca' => 
    array (
      0 => '/var/www/html/aptitudecare/dev/protected/Views/public/leadership_team.tpl',
      1 => 1587155247,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2647209905e7027aea8fb23-82574504',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5e7027aea94cc1_55853892',
  'variables' => 
  array (
    'IMAGES' => 0,
    'SITE_URL' => 0,
...
<?php if ($_valid && !is_callable('content_5e7027aea94cc1_55853892')) {function content_5e7027aea94cc1_55853892($_smarty_tpl) {?><div class="container-fluid">
	<div class="row">
		<div class="col-xl text-center">
			<img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['IMAGES']->value, ENT_QUOTES, 'UTF-8');?>
/staff/leadership-team.jpg" alt="" class="img-fluid">	
		</div>
	</div>
</div>
<div class="container">
	...
	<div class="team-section">
		<div class="row">
			<div class="col-lg text-justify">
				...
				<p>We are here to provide whatever assistance is needed to care for our Seniors; to educate and inform as well as providing services when our services are required. If you have any questions feel free to <a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['SITE_URL']->value, ENT_QUOTES, 'UTF-8');?>
					...
					<button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse1" aria-expanded="false" aria-controls="collapse1">
						<div class="row">
							<div class="col-lg-3 col-sm-12">
								<img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['IMAGES']->value, ENT_QUOTES, 'UTF-8');?>
/staff/beth_rhoden.jpg" alt="" class="float-left rounded">
							</div>
				...
				<div class="card-header" id="heading2">
					<button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse2" aria-expanded="false" aria-controls="collapse2">
						<div class="row">
							<div class="col-lg-3 col-sm-12">
								<img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['IMAGES']->value, ENT_QUOTES, 'UTF-8');?>
/staff/adrienne_bradley.jpg" alt="clinical director for senior care center Anchorage, Alaska elderly care Alaska " class="float-left rounded">
							</div>
							<div class="col-lg-9 col-sm-12">
				...
				<div class="card-header" id="heading3">
					<button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse3" aria-expanded="false" aria-controls="collapse3">
						<div class="row">
							<div class="col-lg-3 col-sm-12">
								<img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['IMAGES']->value, ENT_QUOTES, 'UTF-8');?>
/staff/stephanie_freeman.jpg" alt="business office manager for senior care center Anchorage, Alaska elderly care Alaska " class="float-left rounded">
							</div>
							<div class="col-lg-9 col-sm-12">
				...
				<div class="card-header" id="heading4">
					<button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse4" aria-expanded="false" aria-controls="collapse4">
						<div class="row">
							<div class="col-lg-3 col-sm-12">
								<img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['IMAGES']->value, ENT_QUOTES, 'UTF-8');?>
/staff/anna_houser.jpg" alt="life enrichment director for elderly care center Alaska" class="float-left rounded">
							</div>
							<div class="col-lg-9 col-sm-12">
				...
				<div class="card-header" id="heading5">
					<button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse5" aria-expanded="false" aria-controls="collapse5">
						<div class="row">
							<div class="col-lg-3 col-sm-12">
								<img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['IMAGES']->value, ENT_QUOTES, 'UTF-8');?>
/staff/jericho_mandani.jpg" alt="executive chef for senior care center Anchorage, Alaska" class="float-left rounded">
							</div>
							<div class="col-lg-9 col-sm-12">
				...
				<div class="card-header" id="heading6">
					<button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse6" aria-expanded="false" aria-controls="collapse6">
						<div class="row">
							<div class="col-lg-3 col-sm-12">
								<img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['IMAGES']->value, ENT_QUOTES, 'UTF-8');?>
/staff/tami_ochoa.jpg" alt="admissions coordinator for assisted living Anchorage, Alaska" class="float-left rounded">
							</div>
							<div class="col-lg-9 col-sm-12">
				...
				<div class="card-header" id="heading7">
					<button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse7" aria-expanded="false" aria-controls="collapse7">
						<div class="row">
							<div class="col-lg-3 col-sm-12">
								<img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['IMAGES']->value, ENT_QUOTES, 'UTF-8');?>
/staff/melissa_tanner.jpg" alt="clinical coordinator for senior living Anchorage, Alaska" class="float-left rounded">
							</div>
							<div class="col-lg-9 col-sm-12">
				...
				<div class="card-header" id="heading8">
					<button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse8" aria-expanded="false" aria-controls="collapse8">
						<div class="row">
							<div class="col-lg-3 col-sm-12">
								<img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['IMAGES']->value, ENT_QUOTES, 'UTF-8');?>
/staff/kemish_hendershot2.jpg" alt="coo for assisted living Anchorage, Alaska" class="float-left rounded">
							</div>
							<div class="col-lg-9 col-sm-12">
				...
				<div class="card-header" id="heading8">
					<button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse9" aria-expanded="false" aria-controls="collapse9">
						<div class="row">
							<div class="col-lg-3 col-sm-12">
								<img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['IMAGES']->value, ENT_QUOTES, 'UTF-8');?>
/staff/doug_clegg.jpg" alt="ceo for assisted living Anchorage, Alaska" class="float-left rounded">
							</div>
							<div class="col-lg-9 col-sm-12">
				...
				<div id="collapse9" class="collapse" aria-labelledby="heading9" data-parent="#leadershipAccordion">
					<div class="card-body">
						...
						<img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['IMAGES']->value, ENT_QUOTES, 'UTF-8');?>
/facilities/aerial.jpg" alt="" class="float-right img-fluid">
						...
						<img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['IMAGES']->value, ENT_QUOTES, 'UTF-8');?>
/facilities/spring-creek-sign.jpg" alt="" class="float-left img-fluid">
