<?php /* Smarty version Smarty-3.1.19, created on 2019-08-27 00:18:36
         compiled from "/var/www/html/aptitudecare/modules/Dietary/Views/dietary/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:21256451795c92ac534d9fb9-22322946%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'de3cdcc3bec424b613fbe8291d95a17304daf099' => 
    array (
      0 => '/var/www/html/aptitudecare/modules/Dietary/Views/dietary/index.tpl',
      1 => 1566865093,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21256451795c92ac534d9fb9-22322946',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5c92ac534ed066_58450885',
  'variables' => 
  array (
    'this' => 0,
    'SITE_URL' => 0,
...
<?php if ($_valid && !is_callable('content_5c92ac534ed066_58450885')) {function content_5c92ac534ed066_58450885($_smarty_tpl) {?>
...
<div class="row"">
	...
	<div class="col-lg-4">
		<a id="tray-card-select-date" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['SITE_URL']->value, ENT_QUOTES, 'UTF-8');?>
...
&amp;patient=all&amp;pdf=true" class="btn btn-primary pull-right">Tray Cards</a>
		...
		<a id="meal-order-form-select-date" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['SITE_URL']->value, ENT_QUOTES, 'UTF-8');?>
...
?>
		<td class="room-number" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['patient']->value->number, ENT_QUOTES, 'UTF-8');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['patient']->value->number, ENT_QUOTES, 'UTF-8');?>
		...
		<td class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8');?>
...
, <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['patient']->value->first_name, ENT_QUOTES, 'UTF-8');?>
		...
		<td class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dietaryMenu']->value->menu($_smarty_tpl->tpl_vars['patient']->value,$_smarty_tpl->tpl_vars['selectedLocation']->value), ENT_QUOTES, 'UTF-8');?>
</td>
		<td class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8');?>
">
...
/delete.png" class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8');?>
" style="position: relative; top: 7px;" alt="">
				<input type="hidden" name="public_id" class="public-id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['patient']->value->public_id, ENT_QUOTES, 'UTF-8');?>
">
				<input type="hidden" name="room_number" class="room-number" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['patient']->value->number, ENT_QUOTES, 'UTF-8');?>
">
			</a>
				<input type="hidden" class="patient-id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['patient']->value->public_id, ENT_QUOTES, 'UTF-8');?>
">
			<?php }?>
		</td>
		<?php } else { ?>
