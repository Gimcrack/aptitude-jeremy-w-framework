<?php /* Smarty version Smarty-3.1.19, created on 2019-05-31 23:09:33
         compiled from "/var/www/html/aptitudecare/modules/Dietary/Views/patient_info/diet.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4239216755c956b415d5de2-06558916%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '104d9b700b547f7a0f0e10b0b6dac80ec7d13c0b' => 
    array (
      0 => '/var/www/html/aptitudecare/modules/Dietary/Views/patient_info/diet.tpl',
      1 => 1559344160,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4239216755c956b415d5de2-06558916',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5c956b41613455_42629805',
  'variables' => 
  array (
    'patient' => 0,
    'SITE_URL' => 0,
...
<?php if ($_valid && !is_callable('content_5c956b41613455_42629805')) {function content_5c956b41613455_42629805($_smarty_tpl) {?><h1>Edit Diet <span class="text-24">for</span> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['patient']->value->fullName(), ENT_QUOTES, 'UTF-8');?>
</h1>


<form class="form-inline" action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['SITE_URL']->value, ENT_QUOTES, 'UTF-8');?>
" method="post">
...
">
	...
	<div class="form-group">
		...
		<input type="text" id="middle-name" class="form-control" size="10" name="middle_name" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['patient']->value->middle_name, ENT_QUOTES, 'UTF-8');?>
">
	</div>
	<div class="form-group">
...
">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control datepicker" size="10" name="date_of_birth" value="<?php echo htmlspecialchars(display_date($_smarty_tpl->tpl_vars['patient']->value->date_of_birth), ENT_QUOTES, 'UTF-8');?>
" />
	</div>
...
?>
				<li><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['allergy']->value->name, ENT_QUOTES, 'UTF-8');?>
</li>
				<?php } ?>
			<?php }?>
		</ul>
...
?>
				<li value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dislike']->value->id, ENT_QUOTES, 'UTF-8');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dislike']->value->name, ENT_QUOTES, 'UTF-8');?>
</li>
				<?php } ?>
			<?php }?>
		</ul>
...
?>
				<li value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['equip']->value->id, ENT_QUOTES, 'UTF-8');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['equip']->value->name, ENT_QUOTES, 'UTF-8');?>
</li>
				<?php } ?>
			<?php }?>
		</ul>
...
?>
				<li value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['supplement']->value->id, ENT_QUOTES, 'UTF-8');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['supplement']->value->name, ENT_QUOTES, 'UTF-8');?>
</li>
				<?php } ?>
			<?php }?>
		</ul>
...
?>
							<li value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['req']->value->id, ENT_QUOTES, 'UTF-8');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['req']->value->name, ENT_QUOTES, 'UTF-8');?>
</li>
							<?php } ?>
							<?php }?>
						</ul>
...
?>
							<li><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['beverage']->value->name, ENT_QUOTES, 'UTF-8');?>
</li>
							<?php } ?>
						<?php }?>
					</ul>
...
?>
							<li><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['snack']->value->name, ENT_QUOTES, 'UTF-8');?>
</li>
							<?php } ?>
						<?php }?>
					</ul>
...
?>
	...
	<div class="checkbox">
				<label for="regular" class="checkbox-label">
					<input id="regular" class="checkbox" type="checkbox" name="diet_order[]" value="Regular" <?php if (in_array("Regular",$_smarty_tpl->tpl_vars['dietOrder']->value['standard'])) {?> checked<?php }?>> Regular </label> <label for="aha-cardiac" class="checkbox-label">
					<input id="aha-cardiac" type="checkbox" name="diet_order[]" value="AHA/Cardiac" <?php if (in_array("AHA/Cardiac",$_smarty_tpl->tpl_vars['dietOrder']->value['standard'])) {?> checked<?php }?>> AHA/Cardiac </label> <label class="checkbox-label">
					<input type="checkbox" name="diet_order[]" value="No Added Salt" <?php if (in_array("No Added Salt",$_smarty_tpl->tpl_vars['dietOrder']->value['standard'])) {?> checked<?php }?>> No Added Salt </label> <label class="checkbox-label">
					<input type="checkbox" name="diet_order[]" value="RCS" <?php if (in_array("RCS",$_smarty_tpl->tpl_vars['dietOrder']->value['standard'])) {?> checked<?php }?>> RCS</label> 
					<label class="checkbox-label">
					<input type="checkbox" name="diet_order[]" value="2 gram Na" <?php if (in_array("2 gram Na",$_smarty_tpl->tpl_vars['dietOrder']->value['standard'])) {?>
						checked<?php }?>> 2 gram Na </label> <label class="checkbox-label">
					...
					<input type="checkbox" name="diet_order[]" value="Gluten Restricted" <?php if (in_array("Gluten Restricted",$_smarty_tpl->tpl_vars['dietOrder']->value['standard'])) {?> checked<?php }?>> Gluten Restricted </label> <label class="checkbox-label">
					<input type="checkbox" name="diet_order[]" value="Fortified/High Calorie" <?php if (in_array("Fortified/High Calorie",$_smarty_tpl->tpl_vars['dietOrder']->value['standard'])) {?> checked<?php }?>> Fortified/High Calorie </label> <input type="text" name="diet_order[]"
						class="other-input checkbox-input" placeholder="Enter other diet orders..." style="width: 350px"
						value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dietOrder']->value['other'], ENT_QUOTES, 'UTF-8');?>
">
	</div>
	...
	<div class="checkbox">
		...
		<label for="" class="checkbox-label">
				<input type="checkbox" name="texture[]" value="Easy to Chew" <?php if (in_array('Easy to Chew',$_smarty_tpl->tpl_vars['textures']->value['standard'])) {?> checked<?php }?>>
				Easy to Chew
		</label>		
		<label for="" class="checkbox-label">
		...
		<label for="" class="checkbox-label">
				<input type="checkbox" name="texture[]" value="Soft & Bite Sized" <?php if (in_array('Soft & Bite Sized',$_smarty_tpl->tpl_vars['textures']->value['standard'])) {?> checked<?php }?>>
				Soft &amp; Bite Sized
		</label>
		<label for="" class="checkbox-label">
				<input type="checkbox" name="texture[]" value="Minced & Moist" <?php if (in_array('Minced & Moist',$_smarty_tpl->tpl_vars['textures']->value['standard'])) {?> checked<?php }?>>
				Minced &amp; Moist
		</label>
		<label for="" class="checkbox-label">
				<input type="checkbox" name="texture[]" value="Chopped" <?php if (in_array('Chopped',$_smarty_tpl->tpl_vars['textures']->value['standard'])) {?> checked<?php }?>>
				Chopped
		</label>
		<label for="" class="checkbox-label">
				<input type="checkbox" name="texture[]" value="Chopped Meat" <?php if (in_array('Chopped Meat',$_smarty_tpl->tpl_vars['textures']->value['standard'])) {?> checked<?php }?>>
				Chopped Meat
		</label>
		...
		<input type="text" maxlength="25" name="texture[]" size="50" class="other-input" placeholder="Enter other texture info... (25 character limit)" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['textures']->value['other'], ENT_QUOTES, 'UTF-8');?>
">
	</div>
	...
	<div class="form-header2">Other</div>
		...
		<label for="" class="checkbox-label">
			<input type="text" name="other[]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['other']->value['other'], ENT_QUOTES, 'UTF-8');?>
">
			<!-- <input type="text" name="other[]" class="other-input" placeholder="Enter other order info..." value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['other']->value['other'], ENT_QUOTES, 'UTF-8');?>
"> -->
		</label>
