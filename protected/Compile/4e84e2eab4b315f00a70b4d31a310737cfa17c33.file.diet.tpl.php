<?php /* Smarty version Smarty-3.1.19, created on 2020-05-06 10:52:25
         compiled from "/var/www/html/aptitudecare/dev/modules/Dietary/Views/patient_info/diet.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18107509405d787b5bb104b9-32881994%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4e84e2eab4b315f00a70b4d31a310737cfa17c33' => 
    array (
  ...
  'nocache_hash' => '18107509405d787b5bb104b9-32881994',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5d787b5bb64a59_42800753',
  'variables' => 
  array (
    'patient' => 0,
    'SITE_URL' => 0,
...
<?php if ($_valid && !is_callable('content_5d787b5bb64a59_42800753')) {function content_5d787b5bb64a59_42800753($_smarty_tpl) {?><div class="container diet">
...
"
 ...
 $_from = $_smarty_tpl->tpl_vars['patientAllergies']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
						...
						<?php } ?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['allergy']->value->name, ENT_QUOTES, 'UTF-8');?>
...
"
						<?php  $_smarty_tpl->tpl_vars['pd'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['pd']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['patientDislikes']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['pd']->key => $_smarty_tpl->tpl_vars['pd']->value) {
$_smarty_tpl->tpl_vars['pd']->_loop = true;
?>
							<?php if ($_smarty_tpl->tpl_vars['dislike']->value->id==$_smarty_tpl->tpl_vars['pd']->value->id) {?> selected<?php }?>
						<?php } ?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dislike']->value->name, ENT_QUOTES, 'UTF-8');?>
</option>
					<?php } ?>
				</select>
...
<!-- 			<div class="form-group col-lg-6 col-md-12">
 ...
 $_from = $_smarty_tpl->tpl_vars['specialRequests']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
"
										<?php  $_smarty_tpl->tpl_vars["bsr"] = new Smarty_Variable; $_smarty_tpl->tpl_vars["bsr"]->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['breakfast_spec_req']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars["bsr"]->key => $_smarty_tpl->tpl_vars["bsr"]->value) {
$_smarty_tpl->tpl_vars["bsr"]->_loop = true;
?>
...
?>
									<option 
										value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['sr']->value->id, ENT_QUOTES, 'UTF-8');?>
"
										<?php  $_smarty_tpl->tpl_vars["lsr"] = new Smarty_Variable; $_smarty_tpl->tpl_vars["lsr"]->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['lunch_spec_req']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars["lsr"]->key => $_smarty_tpl->tpl_vars["lsr"]->value) {
$_smarty_tpl->tpl_vars["lsr"]->_loop = true;
?>
...
?>
									<option 
										value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['sr']->value->id, ENT_QUOTES, 'UTF-8');?>
"
										<?php  $_smarty_tpl->tpl_vars["dsr"] = new Smarty_Variable; $_smarty_tpl->tpl_vars["dsr"]->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['dinner_spec_req']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars["dsr"]->key => $_smarty_tpl->tpl_vars["dsr"]->value) {
$_smarty_tpl->tpl_vars["dsr"]->_loop = true;
?>
...
"
										<?php  $_smarty_tpl->tpl_vars["bb"] = new Smarty_Variable; $_smarty_tpl->tpl_vars["bb"]->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['breakfast_beverages']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars["bb"]->key => $_smarty_tpl->tpl_vars["bb"]->value) {
$_smarty_tpl->tpl_vars["bb"]->_loop = true;
?>
...
?>
									<option value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['bev']->value->id, ENT_QUOTES, 'UTF-8');?>
"
										<?php  $_smarty_tpl->tpl_vars["lb"] = new Smarty_Variable; $_smarty_tpl->tpl_vars["lb"]->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['lunch_beverages']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars["lb"]->key => $_smarty_tpl->tpl_vars["lb"]->value) {
$_smarty_tpl->tpl_vars["lb"]->_loop = true;
?>
