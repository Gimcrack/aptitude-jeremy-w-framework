<?php /* Smarty version Smarty-3.1.19, created on 2019-05-16 20:25:20
         compiled from "/var/www/html/aptitudecare/modules/Dietary/Views/info/current.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20203575455c92c2a376fac4-77998248%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6e55f9152560c156419bf5f84a66e68aa298b6c5' => 
    array (
      0 => '/var/www/html/aptitudecare/modules/Dietary/Views/info/current.tpl',
      1 => 1553125343,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20203575455c92c2a376fac4-77998248',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5c92c2a3787358_23034764',
  'variables' => 
  array (
    'this' => 0,
    'SITE_URL' => 0,
...
<?php if ($_valid && !is_callable('content_5c92c2a3787358_23034764')) {function content_5c92c2a3787358_23034764($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/html/aptitudecare/framework/protected/Vendors/Smarty-3.1.19/libs/plugins/modifier.date_format.php';
if (!is_callable('smarty_modifier_truncate')) include '/var/www/html/aptitudecare/framework/protected/Vendors/Smarty-3.1.19/libs/plugins/modifier.truncate.php';
?><script>
...
"><img class="left" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['FRAMEWORK_IMAGES']->value, ENT_QUOTES, 'UTF-8');?>
...
/icons/next-icon.png" alt="next week" /></a>
	...
	<div class="dietary-date-header-text">
		<h1 class="text-24">Week Beginning <?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['startDate']->value,"%A, %B %e, %G"), ENT_QUOTES, 'UTF-8');?>
</h1>
		<?php if ($_smarty_tpl->tpl_vars['today']->value) {?>
			<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['SITE_URL']->value, ENT_QUOTES, 'UTF-8');?>
/?module=Dietary&amp;page=info&amp;action=current&amp;location=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['location']->value->public_id, ENT_QUOTES, 'UTF-8');?>
&amp;weekSeed=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['today']->value, ENT_QUOTES, 'UTF-8');?>
...
<h2><strong>Week <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['menuWeek']->value, ENT_QUOTES, 'UTF-8');?>
</strong> of the <strong><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['menu']->value->name, ENT_QUOTES, 'UTF-8');?>
</strong> Menu</h2>
