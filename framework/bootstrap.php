 ...
 */
	...
	define('VENDORS', SITE_URL . DS . 'vendors');
	...
	define('AWS', 'https://s3.us-west-2.amazonaws.com/aspencreek');
 ...
 */
	...
	require_once(FRAMEWORK_PROTECTED_DIR . DS . 'Vendors' . DS . 'Smarty-3.1.34' . DS . 'libs' . DS . 'Smarty.class.php'); 
 	...
 	require_once(FRAMEWORK_PROTECTED_DIR . DS . 'Vendors/vendor/autoload.php');
